...
public class MechanicSteps {
	...
	public void iTryToAddANewMechanicWithSameDni() throws BusinessException {
		...
		MechanicDto dto = new MechanicUtil().withDni(mechanic.dni).get();
	...
	public void iTryToUpdateTheMechanicToDniNameAndSurname(String name,
		...
		MechanicDto dto = new MechanicUtil().findById(mechanic.id).get();
	...
	public void iTryToFindAMechanicByANonExistentDni()
			throws BusinessException {
	...
	public void theMechanicResultsUpdatedForNameAndSurnameOnly()
			throws BusinessException {
		MechanicDto loaded = new MechanicUtil().findById(mechanic.id).get();
	...
	public void theMechanicResultsAddedToTheSystem() throws BusinessException {
		MechanicCrudService service = Factory.service.forMechanicCrudService();
