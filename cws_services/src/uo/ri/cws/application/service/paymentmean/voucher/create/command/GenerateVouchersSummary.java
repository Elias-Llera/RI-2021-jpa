...
public class GenerateVouchersSummary implements Command<List<VoucherSummaryDto>>{
	...
	public List<VoucherSummaryDto> execute() throws BusinessException {
		...
		for (Client client : allClients) {
			voucherSummary = paymentMeanRepository.findAggregateVoucherDataByClientId(client.getId());
			result.add(toVoucherSummaryDto(client, voucherSummary));
		}
		return result;
	}
	
	private VoucherSummaryDto toVoucherSummaryDto(Client client, Object[] voucherSummary) {
